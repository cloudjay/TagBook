...
%>
	...
	<div class="searchform">
	  <div class="search_query">
		...
		<label for="q">Daum book search</label> 
		<button class="btn waves-effect waves-light indigo" id="b" type="submit" value="Search">Search</button>
		</div>
	...
	<div class="searchform">
	  <div class="search_query">
	    ...
	    <form id="yearform" method="get" action="/list.jsp">
	      ...
	      <select name="fin_year_select" id="fin_year_select" class="browser-default"></select>
